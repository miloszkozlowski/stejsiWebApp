...
public class PakietTreningowService {
	...
	private PakietTreningowRepo repo;
	private PodopiecznyRepo userRepo;
	private TokenRepo tokenRepo;
	private TreningService trainingService;
	private RodzajPakietuService typeService;
	...
	@Transactional
	public PakietReadModel createNew(PakietWriteModel source) throws IllegalArgumentException {
	...
	@Transactional
	public void togglePayment(Long id) throws IllegalArgumentException {
	...
	@Transactional
	public void closePackage(Long pid) throws IllegalArgumentException {
